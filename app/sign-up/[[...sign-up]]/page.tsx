      ...
      <div className="flex min-h-screen items-center justify-center p-6 relative">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold font-display text-gradient mb-2">Get started today</h1>
            <p className="text-muted-foreground">Create your WhatDidiShop account and never lose track of your orders</p>
          </div>
